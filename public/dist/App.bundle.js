	...
	_axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
		...
		markers.forEach(function (marker) {
			return marker.addListener('click', function () {
				var html = '<div class="popup> <a href="/store/' + this.place.slug + '"> <img src="/uploads/' + (this.place.photo || 'store.png') + '" alt="' + this.place.name + '"/><p>' + this.place.name + ' - ' + this.place.location.address + '</p></a></div>';
...
function typeAhead(search) {
	...
	searchInput.on('keyup', function (e) {
		//check for up, down and enter only
